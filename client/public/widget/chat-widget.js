...
function rv() {
  ...
  q.prototype.isReactComponent = {}, q.prototype.setState = function(b, V) {
  ...
  var j = J.prototype = new L();
  j.constructor = J, k(j, q.prototype), j.isPureReactComponent = !0;
  ...
  }, ke.Component = q, ke.Fragment = l, ke.Profiler = u, ke.PureComponent = J, ke.StrictMode = o, ke.Suspense = g, ke.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = W, ke.__COMPILER_RUNTIME = {
    __proto__: null,
    c: function(b) {
...
function lv() {
  return eh || (eh = 1, function(n) {
    ...
    var g = [], m = [], h = 1, v = null, w = 3, x = !1, k = !1, z = !1, q = !1, L = typeof setTimeout == "function" ? setTimeout : null, J = typeof clearTimeout == "function" ? clearTimeout : null, j = typeof setImmediate < "u" ? setImmediate : null;
    function ue(N) {
    ...
    function Te() {
      return q ? !0 : !(n.unstable_now() - se < K);
    }
    function ie() {
      if (q = !1, I) {
...
` + a.stack;
  ...
  var Ht = typeof Object.is == "function" ? Object.is : qb;
  function Zi(e, t) {
    if (Ht(e, t)) return !0;
  ...
  var Lb = kn && "documentMode" in document && 11 >= document.documentMode, Wa = null, ss = null, Ji = null, us = !1;
  function Kf(e, t, a) {
    ...
    if (r = e, typeof e == "function") ms(e) && (y = 1);
      ...
      e: switch (e) {
        ...
        case z:
          ...
          break;
        case q:
          return e = Vt(12, a, t, s | 2), e.elementType = q, e.lanes = f, e;
        case W:
  ...
  function lp(e) {
    ...
    function Se(C, E, D, Q) {
      for (var ce = null, Me = null, me = E, ye = E = 0, ht = null; me !== null && ye < D.length; ye++) {
        ...
        e && me && Le.alternate === null && t(C, me), E = f(Le, E, ye), Me === null ? ce = Le : Me.sibling = Le, Me = Le, me = ht;
      }
      if (ye === D.length)
    ...
    function ge(C, E, D, Q) {
      ...
      for (var ce = null, Me = null, me = E, ye = E = 0, ht = null, Le = D.next(); me !== null && !Le.done; ye++, Le = D.next()) {
        me.index > ye ? (ht = me, me = null) : ht = me.sibling;
        var fa = M(C, me, Le.value, Q);
        if (fa === null) {
          me === null && (me = ht);
          break;
        }
      ...
      if (Le.done)
        return a(C, me), Be && xa(C, ye), ce;
      if (me === null) {
        for (; !Le.done; ye++, Le = D.next())
          Le = F(C, Le.value, Q), Le !== null && (E = f(Le, E, ye), Me === null ? ce = Le : Me.sibling = Le, Me = Le);
        return Be && xa(C, ye), ce;
      }
      for (me = r(me); !Le.done; ye++, Le = D.next())
        Le = O(me, C, ye, Le.value, Q), Le !== null && (e && Le.alternate !== null && me.delete(Le.key === null ? ye : Le.key), E = f(Le, E, ye), Me === null ? ce = Le : Me.sibling = Le, Me = Le);
  ...
  function Rp(e, t) {
    if (t.type !== "stylesheet" || (t.state.loading & 4) !== 0)
      ...
      if (t = an.current, t !== null && ((qe & 4194048) === qe ? gn !== null : (qe & 62914560) !== qe && (qe & 536870912) === 0 || t !== gn))
        throw rr = Cs, pd;
      e.flags |= 8192;
    }
  }
  ...
  function i0(e, t, a) {
    ...
    switch (bs(t), t.tag) {
      ...
      case 13:
        ...
        return a !== e && a && (t.child.flags |= 8192), ql(t, t.updateQueue), et(t), null;
      case 4:
      ...
      case 19:
        ...
        if (r = (t.flags & 128) !== 0, f = s.rendering, f === null)
          ...
          if (!r)
            if (e = Ml(f), e !== null) {
              if (t.flags |= 128, r = !0, e = e.updateQueue, t.updateQueue = e, ql(t, e), hr(s, !0), s.tail === null && s.tailMode === "hidden" && !f.alternate && !Be)
                return et(t), null;
            } else
      ...
      case 22:
      case 23:
        return _n(t), Ms(), r = t.memoizedState !== null, e !== null ? e.memoizedState !== null !== r && (t.flags |= 8192) : r && (t.flags |= 8192), r ? (a & 536870912) !== 0 && (t.flags & 128) === 0 && (et(t), t.subtreeFlags & 6 && (t.flags |= 8192)) : et(t), a = t.updateQueue, a !== null && ql(t, a.retryQueue), a = null, e !== null && e.memoizedState !== null && e.memoizedState.cachePool !== null && (a = e.memoizedState.cachePool.pool), r = null, t.memoizedState !== null && t.memoizedState.cachePool !== null && (r = t.memoizedState.cachePool.pool), r !== a && (t.flags |= 2048), e !== null && $(Ca), null;
      case 24:
  ...
  var qn = !1, it = !1, uu = !1, qp = typeof WeakSet == "function" ? WeakSet : Set, mt = null;
  function l0(e, t) {
    ...
    switch (a.tag) {
      ...
      case 22:
        if (r = a.memoizedState !== null || qn, !r) {
          t = t !== null && t.memoizedState !== null || it, s = qn;
          var f = it;
          qn = r, (it = t) && !f ? ea(
            e,
            a,
  ...
  function Bp(e, t, a) {
    ...
    switch (a.tag) {
      ...
      case 27:
        it || yn(a, t);
        var r = We, s = Nt;
        la(a.type) && (We = a.stateNode, Nt = !1), Ln(
          e,
          t,
          a
      ...
      case 18:
        ...
        break;
      case 4:
        r = We, s = Nt, We = a.stateNode.containerInfo, Nt = !0, Ln(
          e,
          t,
          a
        ), We = r, Nt = s;
      ...
      case 21:
        ...
        break;
      case 22:
        it = (r = it) || a.memoizedState !== null, Ln(
          e,
          t,
          a
        ), it = r;
  ...
  function Vp(e, t) {
    ...
    switch (e.tag) {
      ...
      case 15:
        ...
        break;
      case 1:
        Qt(t, e), Pt(e), r & 512 && (it || a === null || yn(a, a.return)), r & 64 && qn && (e = e.updateQueue, e !== null && (r = e.callbacks, r !== null && (a = e.shared.hiddenCallbacks, e.shared.hiddenCallbacks = a === null ? r : a.concat(r))));
        break;
      case 26:
        var s = cn;
      ...
      case 22:
        ...
        var T = a !== null && a.memoizedState !== null, R = qn, H = it;
        if (qn = R || s, it = H || T, Qt(t, e), it = H, qn = R, Pt(e), r & 8192)
          e: for (t = e.stateNode, t._visibility = s ? t._visibility & -2 : t._visibility | 1, s && (a === null || T || qn || it || za(e)), a = null, t = e; ; ) {
            if (t.tag === 5 || t.tag === 26) {
              if (a === null) {
                T = a = t;
                try {
  ...
  }, u0 = typeof WeakMap == "function" ? WeakMap : Map, Qe = 0, Ke = null, Oe = null, qe = 0, Pe = 0, Ft = null, ta = !1, hi = !1, pu = !1, jn = 0, nt = 0, na = 0, Ra = 0, mu = 0, rn = 0, gi = 0, xr = null, Mt = null, hu = !1, gu = 0, Bl = 1 / 0, Hl = null, aa = null, yt = 0, ia = null, yi = null, bi = 0, yu = 0, bu = null, Kp = null, Ar = 0, vu = null;
  function Gt() {
    if ((Qe & 2) !== 0 && qe !== 0)
      return qe & -qe;
    if (N.T !== null) {
  ...
  function Zp() {
    rn === 0 && (rn = (qe & 536870912) === 0 || Be ? of() : 536870912);
    var e = an.current;
  ...
  function Su() {
    if (Oe !== null) {
      if (Pe === 0)
        ...
        e = Oe, Nn = Ta = null, qs(e), fi = null, pr = 0, e = Oe;
      for (; e !== null; )
  ...
  function vi(e, t) {
    ...
    a !== -1 && (e.timeoutHandle = -1, D0(a)), a = e.cancelPendingCommit, a !== null && (e.cancelPendingCommit = null, a()), Su(), Ke = e, Oe = a = Dn(e.current, null), qe = t, Pe = 0, Ft = null, ta = !1, hi = Zt(e, t), pu = !1, gi = rn = mu = Ra = na = nt = 0, Mt = xr = null, hu = !1, (t & 8) !== 0 && (t |= t & 32);
  ...
  function xu() {
    nt = 4, ta || (qe & 4194048) !== qe && an.current !== null || (hi = !0), (na & 134217727) === 0 && (Ra & 134217727) === 0 || Ke === null || ra(
      Ke,
      qe,
      rn,
      !1
  ...
  function Au(e, t, a) {
    ...
    while (!0);
    return t && e.shellSuspendCounter++, Nn = Ta = null, Qe = r, N.H = s, N.A = f, Oe === null && (Ke = null, qe = 0, cl()), y;
  }
  function f0() {
    for (; Oe !== null; ) nm(Oe);
  }
  function d0(e, t) {
    ...
    Qe |= 2;
    var r = em(), s = tm();
    Ke !== e || qe !== t ? (Hl = null, Bl = vt() + 500, vi(e, t)) : hi = Zt(
      e,
      t
    );
    e: do
    ...
    while (!0);
    return Nn = Ta = null, N.H = r, N.A = s, Qe = a, Oe !== null ? 0 : (Ke = null, qe = 0, cl(), nt);
  }
  function p0() {
    for (; Oe !== null && !ja(); )
      nm(Oe);
  ...
  function Si(e, t, a, r) {
    ...
    t.flags & 32768 ? (Be || r === 1 ? e = !0 : hi || (qe & 536870912) !== 0 ? e = !1 : (ta = e = !0, (r === 2 || r === 9 || r === 3 || r === 6) && (r = an.current, r !== null && r.tag === 13 && (r.flags |= 16384))), im(t, e)) : Ql(t);
  }
  function Ql(e) {
    var t = e;
    do {
  ...
  function rm(e, t, a, r, s, f, y, S, T) {
    ...
    if (t !== null) {
      ...
      if (f = t.lanes | t.childLanes, f |= ds, Fy(
        ...
        S,
        T
      ), e === Ke && (Oe = Ke = null, qe = 0), yi = t, ia = e, bi = a, yu = f, bu = s, Kp = r, (t.subtreeFlags & 10256) !== 0 || (t.flags & 10256) !== 0 ? (e.callbackNode = null, e.callbackPriority = 0, y0(Ba, function() {
        return cm(), null;
          ...
          if (y !== S && S && S.ownerDocument && Yf(
            ...
            if (T !== null && os(S)) {
              ...
              if (H === void 0 && (H = R), "selectionStart" in S)
                ...
                if (M.getSelection) {
                  var O = M.getSelection(), Se = S.textContent.length, ge = Math.min(T.start, Se), Ye = T.end === void 0 ? ge : Math.min(T.end, Se);
                  !O.extend && ge > Ye && (y = Ye, Ye = ge, ge = y);
                  var C = Gf(
                    S,
                    ge
                  ), E = Gf(
                  ...
                  if (C && E && (O.rangeCount !== 1 || O.anchorNode !== C.node || O.anchorOffset !== C.offset || O.focusNode !== E.node || O.focusOffset !== E.offset)) {
                    var D = F.createRange();
                    D.setStart(C.node, C.offset), O.removeAllRanges(), ge > Ye ? (O.addRange(D), O.extend(E.node, E.offset)) : (D.setEnd(E.node, E.offset), O.addRange(D));
                  }
                }
              }
            }
  ...
  function m0(e, t, a) {
    var r = e.pingCache;
    r !== null && r.delete(t), e.pingedLanes |= e.suspendedLanes & a, e.warmLanes &= ~a, Ke === e && (qe & a) === a && (nt === 4 || nt === 3 && (qe & 62914560) === qe && 300 > vt() - gu ? (Qe & 2) === 0 && vi(e, 0) : mu |= a, gi === qe && (gi = 0)), vn(e);
  }
  function dm(e, t) {
  ...
  function Nu(e, t, a, r, s) {
    ...
    kf(function() {
      ...
      if ((t & 7) === 0) {
        e: {
          if (M = e === "mouseover" || e === "pointerover", O = e === "mouseout" || e === "pointerout", M && a !== Ko && (Se = a.relatedTarget || a.fromElement) && (Va(Se) || Se[Ha]))
            break e;
          if ((O || M) && (M = H.window === H ? H : (M = H.ownerDocument) ? M.defaultView || M.parentWindow : window, O ? (Se = a.relatedTarget || a.toElement, O = R, Se = Se ? Va(Se) : null, Se !== null && (Ye = c(Se), ge = Se.tag, Se !== Ye || ge !== 5 && ge !== 27 && ge !== 6) && (Se = null)) : (O = null, Se = R), O !== Se)) {
            if (ge = Rf, Q = "onMouseLeave", C = "onMouseEnter", E = "mouse", (e === "pointerout" || e === "pointerover") && (ge = Mf, Q = "onPointerLeave", C = "onPointerEnter", E = "pointer"), Ye = O == null ? M : Vi(O), D = Se == null ? M : Vi(Se), M = new ge(
              Q,
              E + "leave",
              O,
              a,
              ...
              a,
              H
            ), ge.target = D, ge.relatedTarget = Ye, Q = ge), Ye = Q, O && Se)
              t: {
                for (ge = O, C = Se, E = 0, D = ge; D; D = Ai(D))
                  E++;
        ...
        e: {
          if (M = R ? Vi(R) : window, O = M.nodeName && M.nodeName.toLowerCase(), O === "select" || O === "input" && M.type === "file")
            ...
            O = M.nodeName, !O || O.toLowerCase() !== "input" || M.type !== "checkbox" && M.type !== "radio" ? R && Xo(R.elementType) && (ce = Bf) : ce = Ib;
          if (ce && (ce = ce(e, R))) {
            jf(
              F,
              ce,
        ...
        switch (Me = R ? Vi(R) : window, e) {
          case "focusin":
            (Lf(Me) || Me.contentEditable === "true") && (Wa = Me, ss = R, Ji = null);
            break;
          case "focusout":
            Ji = ss = Wa = null;
            break;
        ...
        ye && (Of && a.locale !== "ko" && (Ja || ye !== "onCompositionStart" ? ye === "onCompositionEnd" && Ja && (me = Df()) : (Pn = H, $o = "value" in Pn ? Pn.value : Pn.textContent, Ja = !0)), Me = Xl(R, ye), 0 < Me.length && (ye = new Nf(
          ...
          a,
          H
        ), F.push({ event: ye, listeners: Me }), me ? ye.data = me : (me = qf(a), me !== null && (ye.data = me)))), (me = Db ? zb(e, a) : Rb(e, a)) && (ye = Xl(R, "onBeforeInput"), 0 < ye.length && (Me = new Nf(
          "onBeforeInput",
          "beforeinput",
          null,
          a,
...
`).replace(E0, "");
  ...
  function C0(e, t, a, r) {
          ...
          if (a.hasOwnProperty(O) && F != null)
            switch (O) {
              ...
              case "defaultValue":
                T = F;
              default:
                r.hasOwnProperty(O) || Ge(e, t, O, null, r, F);
            }
        }
        for (var M in r) {
          var O = r[M];
    ...
    for (F in r)
      M = r[F], O = a[F], !r.hasOwnProperty(F) || M === O || M == null && O == null || Ge(e, t, F, M, r, O);
  }
  var Ou = null, _u = null;
  function Zl(e) {
...
function zo(n, i, l) {
  ...
  function h(k, z, q) {
    ...
    if (k && !q && typeof k == "object") {
      ...
      else if (U.isArray(k) && $v(k) || (U.isFileList(k) || U.endsWith(z, "[]")) && (L = U.toArray(k)))
        return z = Cg(z), L.forEach(function(j, ue) {
    ...
    return xc(k) ? !0 : (i.append(oh(q, z, c), m(k)), !1);
  }
  ...
  function x(k, z) {
    if (!U.isUndefined(k)) {
      ...
      v.push(k), U.forEach(k, function(L, J) {
        (!(U.isUndefined(L) || L === null) && u.call(
          i,
          L,
          U.isString(J) ? J.trim() : J,
          z,
          w
        )) === !0 && x(L, z ? z.concat(J) : [J]);
      }), v.pop();
    }
  }
  if (!U.isObject(n))
...
const _g = (n) => {
  ...
  return new Promise(function(l, o) {
    ...
    q.open(u.method.toUpperCase(), u.url, !0), q.timeout = u.timeout;
    function L() {
      if (!q)
        return;
      const j = It.from(
        ...
        data: !p || p === "text" || p === "json" ? q.responseText : q.response,
        status: q.status,
    ...
    "onloadend" in q ? q.onloadend = L : q.onreadystatechange = function() {
      !q || q.readyState !== 4 || q.status === 0 && !(q.responseURL && q.responseURL.indexOf("file:") === 0) || setTimeout(L);
    }, q.onabort = function() {
      q && (o(new Ce("Request aborted", Ce.ECONNABORTED, n, q)), q = null);
    }, q.onerror = function() {
      o(new Ce("Network Error", Ce.ERR_NETWORK, n, q)), q = null;
    ...
    }, c === void 0 && d.setContentType(null), "setRequestHeader" in q && U.forEach(d.toJSON(), function(ue, W) {
      q.setRequestHeader(W, ue);
    }), U.isUndefined(u.withCredentials) || (q.withCredentials = !!u.withCredentials), p && p !== "json" && (q.responseType = u.responseType), m && ([w, k] = xo(m, !0), q.addEventListener("progress", w)), g && q.upload && ([v, x] = xo(g), q.upload.addEventListener("progress", v), q.upload.addEventListener("loadend", x)), (u.cancelToken || u.signal) && (h = (j) => {
      q && (o(!j || j.type ? new Mi(null, n, q) : j), q.abort(), q = null);
...
const IS = async (n) => {
  ...
  let q;
  try {
    if (g && _S && l !== "get" && l !== "head" && (q = await US(h, o)) !== 0) {
      let W = new Request(i, {
        method: "POST",
        body: o,
        duplex: "half"
...
const gh = (n) => `- ${n}`, LS = (n) => U.isFunction(n) || n === null || n === !1, qg = {
  getAdapter: (n) => {
    n = U.isArray(n) ? n : [n];
    const { length: i } = n;
    let l, o;
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const e1 = [["path", { d: "M21 12a9 9 0 1 1-6.219-8.56", key: "13zald" }]], Pg = qt("loader-circle", e1);
/**
 * @license lucide-react v0.525.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Fc = "-", b1 = (n) => {
  ...
  for (let m = p.length - 1; m >= 0; m -= 1) {
    ...
    let q = !!z, L = o(q ? k.substring(0, z) : k);
    if (!L) {
      if (!q) {
        g = h + (g.length > 0 ? " " + g : g);
        continue;
    ...
    const J = c(w).join(":"), j = x ? J + kc : J, ue = j + L;
    if (d.includes(ue))
      continue;
    d.push(ue);
    const W = u(L, q);
...
const ct = (n) => {
  ...
  const n = ct("color"), i = ct("font"), l = ct("text"), o = ct("font-weight"), u = ct("tracking"), c = ct("leading"), d = ct("breakpoint"), p = ct("container"), g = ct("spacing"), m = ct("radius"), h = ct("shadow"), v = ct("inset-shadow"), w = ct("text-shadow"), x = ct("drop-shadow"), k = ct("blur"), z = ct("perspective"), q = ct("aspect"), L = ct("ease"), J = ct("animate"), j = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], ue = () => [
    "center",
    "top",
    "bottom",
    "left",
    ...
    de,
    fe
  ], te = () => ["", Ne, Lr, Ma], xe = () => ["solid", "dashed", "dotted", "double"], oe = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], ze = () => [Ne, ic, Th, wh], we = () => [
    // Deprecated since Tailwind CSS v4.0.0
    "",
    "none",
    k,
...
let ix = 0;
const De = La(), ot = La(), Rc = La(), Z = La(), Ze = La(), zi = La(), Xt = La();
function La() {
  return 2 ** ++ix;
}
...
`, m = "/", h = "*", v = "", w = "comment", x = "declaration";
  oc = function(z, q) {
    ...
    function ue() {
      var re = { line: L, column: J };
      return function(Y) {
        return Y.position = new W(re), K(), Y;
      };
    }
    function W(re) {
      this.start = re, this.end = { line: L, column: J }, this.source = q.source;
    }
    ...
    function I(re) {
      ...
      if (Y.reason = re, Y.filename = q.source, Y.line = L, Y.column = J, Y.source = z, !q.silent) throw Y;
    }
    function le(re) {
      var Y = re.exec(z);
      if (Y) {
...
function nA(n) {
  ...
  function z(j) {
    if (j === null) {
      q(n.exit("chunkFlow"), !0), L(0), n.consume(j);
      return;
    }
    return Ae(j) ? (n.consume(j), q(n.exit("chunkFlow")), o = 0, i.interrupt = void 0, p) : (n.consume(j), z);
  }
  function q(j, ue) {
    ...
    if (ue && W.push(null), j.previous = c, c && (c.next = j), c = j, u.defineSkip(j.start), u.write(W), i.parser.lazy[j.start.line]) {
      ...
      for (L(o), I = le; I < i.events.length; )
        i.events[I][1].end = {
          ...Te
        }, I++;
...
function mA(n, i, l) {
  ...
  function z(I) {
    return n.attempt(u, ue, q)(I);
  }
  function q(I) {
    return n.enter("lineEnding"), n.consume(I), n.exit("lineEnding"), L;
  }
  function L(I) {
...
function TA(n, i) {
  ...
  for (x = l; ++w < p.length; )
    ...
    p[w][0] === "exit" && p[w - 1][0] === "enter" && p[w][1].type === p[w - 1][1].type && p[w][1].start.line !== p[w][1].end.line && (z = w + 1, q.push(z), x._tokenizer = void 0, x.previous = void 0, x = x.next);
  for (d.events = [], x ? (x._tokenizer = void 0, x.previous = void 0) : q.pop(), w = q.length; w--; ) {
    const L = p.slice(q[w], q[w + 1]), J = c.pop();
    g.push([J, J + L.length - 1]), n.splice(J, 2, L);
  }
...
function wy(n, i, l, o, u, c, d, p, g) {
  ...
  function z(L) {
    return !h && (L === null || L === 41 || Ut(L)) ? (n.exit("chunkString"), n.exit(p), n.exit(d), n.exit(o), i(L)) : h < m && L === 40 ? (n.consume(L), h++, z) : L === 41 ? (n.consume(L), h--, z) : L === null || L === 32 || L === 40 || Oc(L) ? l(L) : (n.consume(L), L === 92 ? q : z);
  }
  function q(L) {
...
function PA(n, i, l) {
  ...
  function v(A) {
    return A === 33 ? (n.consume(A), w) : A === 47 ? (n.consume(A), c = !0, z) : A === 63 ? (n.consume(A), u = 3, o.interrupt ? i : b) : An(A) ? (n.consume(A), d = String.fromCharCode(A), q) : l(A);
  }
  function w(A) {
  ...
  function z(A) {
    return An(A) ? (n.consume(A), d = String.fromCharCode(A), q) : l(A);
  }
  function q(A) {
    if (A === null || A === 47 || A === 62 || Ut(A)) {
      const te = A === 47, xe = d.toLowerCase();
      return !te && !c && Qh.includes(xe) ? (u = 1, o.interrupt ? i(A) : ee(A)) : jA.includes(d.toLowerCase()) ? (u = 6, te ? (n.consume(A), L) : o.interrupt ? i(A) : ee(A)) : (u = 7, o.interrupt && !o.parser.lazy[o.now().line] ? l(A) : c ? J(A) : j(A));
    }
    return A === 45 || Kt(A) ? (n.consume(A), d += String.fromCharCode(A), q) : l(A);
  }
  function L(A) {
...
function XA(n, i, l) {
  ...
  function z(b) {
    return b === null ? l(b) : b === 93 ? (n.consume(b), q) : Ae(b) ? (d = z, G(b)) : (n.consume(b), z);
  }
  function q(b) {
...
function Iw(n, i, l) {
  ...
  function v(ie) {
    return d = on(d, ie), q(), d[d.length - 1] !== null ? [] : (K(i, 0), m.events = $c(c, m.events, m), m.events);
  }
  function w(ie, ee) {
    return qw(x(ie), ee);
  }
    ...
    for (; o._index < d.length; ) {
      ...
      if (typeof ee == "string")
        for (ie = o._index, o._bufferIndex < 0 && (o._bufferIndex = 0); o._index === ie && o._bufferIndex < ee.length; )
          L(ee.charCodeAt(o._bufferIndex));
      else
        L(ee);
    }
  }
...
function Pw(n, i, l) {
  return typeof i != "string" && (l = i, i = void 0), Fw(l)(jw(Lw(l).document().write(Bw()(n, i, !0))));
}
function Fw(n) {
  const i = {
    transforms: [],
...
function CT(n) {
  ...
  for (; ++g < n.footnoteOrder.length; ) {
    ...
    if (q && q.type === "element" && q.tagName === "p") {
      ...
      J && J.type === "text" ? J.value += " " : q.children.push({ type: "text", value: " " }), q.children.push(...k);
    } else
      h.push(...k);
    const L = {
      type: "element",
    ...
    function w() {
      ...
      if ("children" in g && g.children) {
        ...
        if (L.children && x[0] !== OT)
          for (z = (o ? L.children.length : -1) + d, q = h.concat(L); z > -1 && z < L.children.length; ) {
            const J = L.children[z];
            if (k = p(J, z, q)(), k[0] === $h)
              return k;
...
function QT() {
  ...
  return fc = function g() {
    var m, h, v, w, x, k, z = arguments[0], q = 1, L = arguments.length, J = !1;
    for (typeof z == "boolean" && (J = z, z = arguments[1] || {}, q = 2), (z == null || typeof z != "object" && typeof z != "function") && (z = {}); q < L; ++q)
      if (m = arguments[q], m != null)
        for (h in m)
...
function vE(n) {
  ...
  let c = n;
  return c = c.replace(i, (d) => `${d}`), l.forEach((d) => {
    c = c.replace(d, (p) => `${p.replace(/[\s\(\)\-\.]/g, "")}`);
  }), o.forEach((d) => {
    c = c.replace(d, (p) => `${p.startsWith("http") ? p : `https://${p}`}`);
  }), c = c.replace(u, (d) => `${encodeURIComponent(d)}`), c;
}
  ...
  return /* @__PURE__ */ _.jsx("div", { className: `prose prose-sm max-w-none dark:prose-invert ${i}`, children: /* @__PURE__ */ _.jsx(
    pE,
    {
      components: {
        ...
        p: ({ children: o }) => /* @__PURE__ */ _.jsx("p", { className: "mb-2 last:mb-0", children: o }),
        ul: ({ children: o }) => /* @__PURE__ */ _.jsx("ul", { className: "list-disc list-inside mb-2 space-y-1", children: o }),
        ol: ({ children: o }) => /* @__PURE__ */ _.jsx("ol", { className: "list-decimal list-inside mb-2 space-y-1", children: o }),
        li: ({ children: o }) => /* @__PURE__ */ _.jsx("li", { className: "text-sm", children: o }),
        strong: ({ children: o }) => /* @__PURE__ */ _.jsx("strong", { className: "font-semibold", children: o }),
        em: ({ children: o }) => /* @__PURE__ */ _.jsx("em", { className: "italic", children: o }),
        code: ({ children: o }) => /* @__PURE__ */ _.jsx("code", { className: "bg-gray-200 dark:bg-gray-700 px-1 py-0.5 rounded text-xs font-mono", children: o }),
        pre: ({ children: o }) => /* @__PURE__ */ _.jsx("pre", { className: "bg-gray-100 dark:bg-gray-800 p-2 rounded text-xs overflow-x-auto", children: o }),
        h1: ({ children: o }) => /* @__PURE__ */ _.jsx("h1", { className: "text-lg font-bold mb-2", children: o }),
        h2: ({ children: o }) => /* @__PURE__ */ _.jsx("h2", { className: "text-base font-bold mb-2", children: o }),
        h3: ({ children: o }) => /* @__PURE__ */ _.jsx("h3", { className: "text-sm font-bold mb-1", children: o }),
        a: ({ children: o, href: u }) => {
          const { type: c, style: d } = bE(u || "");
          return c === "email" ? /* @__PURE__ */ _.jsx(
            "a",
            {
              href: u,
...
function SE({ message: n, timestamp: i, companyTheme: l }) {
...
function xE({
  ...
  const [w, x] = pe.useState(""), [k, z] = pe.useState(!1), [q, L] = pe.useState(!1), [J, j] = pe.useState(!1), [ue, W] = pe.useState(""), [I, le] = pe.useState(!1), [K, se] = pe.useState(!1), Te = async (Y) => {
    const ne = Y.split(" ");
    let N = "";
    z(!0), u?.(!0), x("");
  ...
  return /* @__PURE__ */ _.jsxs(_.Fragment, { children: [
    /* @__PURE__ */ _.jsxs("div", { className: "flex gap-3 max-w-[98%] mx-auto px-4 py-6 flex-row", children: [
      ...
      q && /* @__PURE__ */ _.jsxs("div", { className: "flex-1 space-y-2 text-left", children: [
        /* @__PURE__ */ _.jsx(
          "div",
          {
        ...
        !k && /* @__PURE__ */ _.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
          ...
          K && /* @__PURE__ */ _.jsx("span", { className: "text-xs text-green-500 ml-1", children: "Copied!" }),
          o && /* @__PURE__ */ _.jsx(
            "div",
            {
    ...
    J && /* @__PURE__ */ _.jsx("div", { className: "fixed inset-0 bg-gray-900/75 dark:bg-black/75 flex items-center justify-center z-50", children: /* @__PURE__ */ _.jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full mx-4", children: [
...
function AE({ message: n, messageIndex: i, liked: l, isUser: o, timestamp: u, onStreamingChange: c, skipStreaming: d, companyTheme: p, isLastAiMessage: g, companyName: m, companyId: h, onRatingChange: v, onStreamingComplete: w }) {
...
// @__NO_SIDE_EFFECTS__
function EE(n) {
  const i = /* @__PURE__ */ kE(n), l = pe.forwardRef((o, u) => {
    const { children: c, ...d } = o, p = pe.Children.toArray(c), g = p.find(zE);
    if (g) {
      ...
      return /* @__PURE__ */ _.jsx(i, { ...d, ref: u, children: pe.isValidElement(m) ? pe.cloneElement(m, void 0, h) : null });
    }
    return /* @__PURE__ */ _.jsx(i, { ...d, ref: u, children: c });
  });
  return l.displayName = `${n}.Slot`, l;
}
var CE = /* @__PURE__ */ EE("Slot");
// @__NO_SIDE_EFFECTS__
function kE(n) {
  const i = pe.forwardRef((l, o) => {
    const { children: u, ...c } = l;
    if (pe.isValidElement(u)) {
      const d = NE(u), p = RE(c, u.props);
      return u.type !== pe.Fragment && (p.ref = o ? TE(o, d) : d), pe.cloneElement(u, p);
    }
...
function zE(n) {
  return pe.isValidElement(n) && typeof n.type == "function" && "__radixId" in n.type && n.type.__radixId === DE;
}
function RE(n, i) {
  const l = { ...i };
  for (const o in i) {
...
const cg = (n) => typeof n == "boolean" ? `${n}` : n === 0 ? "0" : n, fg = Gg, ME = (n, i) => (l) => {
  var o;
...
function By({
  ...
  return /* @__PURE__ */ _.jsx(
    ...
    {
      "data-slot": "button",
      className: qa(OE({ variant: i, size: l, className: n })),
      ...u
    }
  );
}
function _E({ className: n, ...i }) {
  return /* @__PURE__ */ _.jsx(
    "textarea",
    {
      "data-slot": "textarea",
...
function IE({ onSendMessage: n, isLoading: i = !1, placeholder: l = "Type your message...", companyTheme: o, verifiedPlan: u }) {
    ...
    /* @__PURE__ */ _.jsxs("form", { onSubmit: p, className: "relative", children: [
      ...
      /* @__PURE__ */ _.jsxs(
        By,
        {
          ...
          children: [
            i ? /* @__PURE__ */ _.jsx(Pg, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ _.jsx(o1, { className: "h-4 w-4 text-white" }),
...
function KE({ children: n }) {
  const [i, l] = pe.useState(XE), [o, u] = pe.useState(!1);
  pe.useEffect(() => {
  ...
  }, []), d = pe.useCallback((g) => GE(i, g), [i]), p = pe.useMemo(() => ({
    currentLanguage: i,
    setLanguage: c,
    t: d,
...
function ZE({ className: n = "", variant: i = "dropdown", companyName: l, companyId: o }) {
...
function rC({
  ...
  pe.useEffect(() => {
    ...
    j ? (k(!0), console.log("🔄 Fetching company theme via service..."), JE.getCompanyTheme(j, I || "", w).then((ae) => {
      v(ae), setTimeout(() => {
        k(!1), q(!0);
      }, 100);
    }).catch((ae) => {
  ...
  const xe = (ae, je) => {
    ...
    try {
      ...
      const $e = await iC.getAnswer(be, Ue, c);
      if ($e) {
        if ($e.source === "limit_reached" || $e.limitReached) {
          ...
          se((qi) => [...qi, vt]), j && dn.trackMessageReceived(j, I || "", vt.content, "limit_reached");
          return;
        }
  ...
  return l ? /* @__PURE__ */ _.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ _.jsxs("div", { className: "relative group", children: [
        ...
        ue === "free" && /* @__PURE__ */ _.jsxs("div", { className: "absolute bottom-full right-0 mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none", children: [
      ...
      children: [
        ...
        /* @__PURE__ */ _.jsxs("div", { className: "flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800", children: [
          /* @__PURE__ */ _.jsxs("div", { className: "flex items-center gap-3", children: [
            W ? /* @__PURE__ */ _.jsx("div", { className: "w-8 h-8 rounded-full flex items-center justify-center", children: /* @__PURE__ */ _.jsx("img", { src: W, alt: "Company Logo", className: "w-7 h-7" }) }) : (
              // Default logo
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ _.jsxs("div", { className: "py-4 pb-8", children: [
                ...
                Te && /* @__PURE__ */ _.jsx(wE, { companyTheme: h })
              ] }),
              /* @__PURE__ */ _.jsx("div", { ref: d, className: "h-2" })
            ]
          }
        ),
        !N && !Y && /* @__PURE__ */ _.jsx("div", { className: "absolute bottom-27 right-4 z-10", children: /* @__PURE__ */ _.jsxs(
          By,
          {
            onClick: V,
            size: "sm",
...
const lC = 400, oC = 1300, Oa = {
  ...
  return /* @__PURE__ */ _.jsx(Py.Provider, { value: {
    colors: m,
...
}, dC = (n, i) => (console.log("🔍 Verifying plan authenticity:", { scriptPlan: n, companyPlan: i }), n === "free" ? n : n === i ? (console.log("✅ Plan verification successful: plans match"), i) : (console.log("⚠️ Plan mismatch detected: using company plan as source of truth"), console.log("Script plan:", n, "Company plan:", i), i)), pC = async (n) => {
...
function mC(n, i) {
  ho && ho.unmount(), ho = dv.createRoot(n), ho.render(
    /* @__PURE__ */ _.jsx(go.StrictMode, { children: /* @__PURE__ */ _.jsx(sC, { initialTheme: i.theme, children: /* @__PURE__ */ _.jsx(KE, { children: /* @__PURE__ */ _.jsx(hC, { config: i }) }) }) })
  );
}
function hC({ config: n }) {
  const { defaultTheme: i, toggleTheme: l, isThemeChanging: o } = uC(), [u, c] = go.useState(!0), [d, p] = go.useState(!1);
  if (go.useEffect(() => {
    pC(n).then(p);
  }, [n]), !d)
    return null;
...
typeof window < "u" && (window.QuriusChatWidget = gC);
export {
  gC as default
};
