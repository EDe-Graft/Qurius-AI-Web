        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-2xl mx-auto sm:my-8 max-h-[95vh] sm:max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center space-x-3 flex-1 min-w-0">
              {mode === 'view' && <Eye className="h-5 w-5 text-blue-600 flex-shrink-0" />}
              {mode === 'add' && <Building2 className="h-5 w-5 text-green-600 flex-shrink-0" />}
              {mode === 'edit' && <Edit className="h-5 w-5 text-purple-600 flex-shrink-0" />}
              <h2 className="text-base sm:text-lg sm:text-xl font-semibold text-gray-900 dark:text-gray-100">
            ...
            <Button
              ...
              size="sm"
              onClick={onClose}
              className="h-8 w-8 p-0 hover:bg-red-500 dark:hover:bg-red-500 flex-shrink-0"
            >
              <X className="h-4 w-4" />
            </Button>
          </div>
            ...
            {mode === 'view' ? (
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-3 sm:space-x-4">
                  <div 
                    className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl flex items-center justify-center text-white text-lg sm:text-xl font-bold flex-shrink-0"
                    style={{ backgroundColor: formData.theme.primaryColor }}
                  >
                    {formData.name.charAt(0).toUpperCase()}
                  </div>
                  <div className="min-w-0 flex-1">
                    <h3 className="text-lg sm:text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 truncate">
                      {formData.name}
                    </h3>
                    <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">{formData.industry}</p>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="flex items-center mt-1 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        ...
                        <span className="text-gray-900 dark:text-gray-100 truncate">{formData.domain}</span>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center mt-1 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        ...
                        <span className="text-gray-900 dark:text-gray-100 truncate">{formData.location}</span>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center mt-1 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        <div 
                          ...
                          style={{ backgroundColor: formData.theme.primaryColor }}
                        />
                        <span className="text-gray-900 dark:text-gray-100 truncate">{formData.theme.primaryColor}</span>
                      </div>
                    </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div>
                    ...
                    />
                    {errors.domain && (
                      <p className="mt-1 text-xs sm:text-sm text-red-600 dark:text-red-400">{errors.domain}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  <div>
                    ...
                    />
                    {errors.location && (
                      <p className="mt-1 text-xs sm:text-sm text-red-600 dark:text-red-400">{errors.location}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {errors.industry && (
                      <p className="mt-1 text-xs sm:text-sm text-red-600 dark:text-red-400">{errors.industry}</p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={cn(
                      "w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent",
                      "bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600",
                      "text-gray-900 dark:text-gray-100 text-sm resize-none",
                      errors.description && "border-red-500 focus:ring-red-500"
                    )}
                    placeholder="Brief description of the company"
                  />
                  {errors.description && (
                    <p className="mt-1 text-xs sm:text-sm text-red-600 dark:text-red-400">{errors.description}</p>
                  )}
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  <div>
                    ...
                    />
                    {errors.website && (
                      <p className="mt-1 text-xs sm:text-sm text-red-600 dark:text-red-400">{errors.website}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {errors.contact_email && (
                      <p className="mt-1 text-xs sm:text-sm text-red-600 dark:text-red-400">{errors.contact_email}</p>
                    )}
                  </div>
                </div>
            ...
            <div className="flex space-x-3 w-full sm:w-auto">
              {mode === 'edit' && company?.id && onDelete && (
                <Button
                  ...
                  className="border-red-300 text-red-700 hover:bg-red-50 dark:border-red-700 dark:text-red-400 dark:hover:bg-red-900 w-full sm:w-auto"
                >
